...
public class TaskDialogScreen extends javax.swing.JDialog {
    ...
    // Preencher os campos com os dados da tarefa
        ...
        // Tentar formatar a data de prazo, caso esteja presente
    ...
    private void jPanelToolBarSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelToolBarSaveMouseClicked
        ...
        try {
            ...
            Task task = this.task;
              ...
              if (task == null) {
            // Se task for nula, criamos uma nova tarefa (caso contrário, editamos uma existente)
              task = new Task();
            }
            ...
            // Salvar a tarefa usando o controller
             if (task.getId() == 0) {
            // Se a tarefa não tiver ID (é nova), salvar como nova
            controller.save(task);
            JOptionPane.showMessageDialog(rootPane, "Tarefa criada com sucesso!");
            } else {
            // Caso contrário, atualizar a tarefa
            controller.update(task); // Aqui é importante garantir que o controller tem um método de update
